...
pw.box %>% filter(pop1 == "10" | pop2 == "10") %>% filter(pop1 != pop2) %>% mutate(mean = mean(Dps)) #avg. is 0.373
pw.box %>% filter(pop1 == "10" | pop2 == "10") %>% filter(pop1 == pop2) %>% mutate(mean = mean(Dps)) #0.308
```
