...
kable(ibd_l[[2]], caption = "Fst mantel stats", digits = 3)
kable(ibd_l[[3]], caption = "Gst mantel stats", digits = 3)
```
For each metric, looks like 2019 falls most within the IBD framework, none of the years follow IBstreamD though.
